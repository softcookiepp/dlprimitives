...
class AllPrograms
{
	...
	tart::program_ptr mPointwiseReduceUnaryBinaryProgram = nullptr;
	tart::program_ptr mPointwiseReduceBinaryUnaryProgram = nullptr;
	tart::program_ptr mPointwiseReduceTrinaryUnaryProgram = nullptr;
	tart::program_ptr mPointwiseReduceQuaternaryUnaryProgram = nullptr;
...
public:
	...
	inline const tart::program_ptr& pointwise_reduce_binary_unary(const tart::device_ptr& device,
		const tart::DType& x0t, const tart::DType& x1t, const tart::DType& y0t)
	{
		return getAllPrograms(device, {x0t, x1t, y0t}).mPointwiseReduceBinaryUnaryProgram;
	}
	
	inline const tart::program_ptr& pointwise_reduce_trinary_unary(const tart::device_ptr& device,
		const tart::DType& x0t, const tart::DType& x1t, const tart::DType& x2t, const tart::DType& y0t)
	{
		return getAllPrograms(device, {x0t, x1t, x2t, y0t}).mPointwiseReduceBinaryUnaryProgram;
	}
	...
	inline const tart::program_ptr& pointwise_reduce_unary_binary(const tart::device_ptr& device,
		const tart::DType& x0t, const tart::DType& y0t, const tart::DType& y1t)
	{
		return getAllPrograms(device, {x0t, y0t, y1t}).mPointwiseReduceUnaryBinaryProgram;
	}
