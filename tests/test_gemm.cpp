...
void test_mm(int batch,int m,int n,int k,bool ta,bool tb,float beta, const tart::device_ptr& device)
{
    ...
    dp::core::pointwiseOpStrided({A},{A},{}, dlprim::core::PointwiseOp::eRound);
    dp::core::pointwiseOpStrided({B},{B},{}, dlprim::core::PointwiseOp::eRound);
    ...
    if(use_batch) {
        dlprim::gpu::GEMM::batch_sgemm(
            tart::dtypes::float32,ta,tb,batch,
            m,n,k,
